(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ListUrlsComponent = /** @class */ (function () {
                function ListUrlsComponent(url, flashMessage, router) {
                    this.url = url;
                    this.flashMessage = flashMessage;
                    this.router = router;
                }
                ListUrlsComponent.prototype.ngOnInit = function () {
                    this.getAllUrls();
                };
                ListUrlsComponent.prototype.getAllUrls = function () {
                    var _this = this;
                    this.url.allUrls().subscribe(function (res) {
                        if (res['status'] === "done") {
                            _this.allUrls = res['data'];
                        }
                        else {
                ...
                ListUrlsComponent.prototype.eidtRedirect = function (_id) {
                    this.router.navigate(["/home/updateUrl/" + _id]);
                    //console.log(_id);
                };
                ListUrlsComponent.prototype.deleteUrl = function (_id) {
                    var _this = this;
                    this.url.deleteUrl(_id).subscribe(function (res) {
                        console.log({ res: res });
                        if (res['status'] === "done") {
                            _this.flashMessage.show(res['status'] + " : SuccessFull Delete ", { cssClass: "alert-success" });
                            _this.getAllUrls();
                        }
                        else {
                            _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: "alert-danger" });
                ...
                ListUrlsComponent.prototype.activeStatus = function (link, _id, status) {
                    var _this = this;
                    this.url.newOrUpdateUrl({ link: link, _id: _id, status: status }, 'update').subscribe(function (res) {
                        if (res['status'] === "done") {
                            _this.getAllUrls();
                        }
                        else {
                ...
                return ListUrlsComponent;
            }());
            ListUrlsComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                function LoginComponent(fb, user, router, flashMessage) {
                    this.fb = fb;
                    this.user = user;
                    this.router = router;
                    this.flashMessage = flashMessage;
                ...
                LoginComponent.prototype.getFormError = function () {
                    var _this = this;
                    Object.keys(this.loginForm.controls).forEach(function (controll) {
                        _this.loginFormErrors[controll] = '';
                        if (_this.loginForm.get(controll).invalid) {
                            Object.keys(_this.loginForm.get(controll).errors).forEach(function (error) {
                                _this.loginFormErrors[controll] += _my_validation__WEBPACK_IMPORTED_MODULE_5__["MyValidation"].errorMessage(error, controll);
                            });
                        }
                    });
                };
                LoginComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.user.loginOrSignupOrupdate(this.loginForm.value, 'login').subscribe(function (res) {
                        if (res['status'] === "done") {
                            _this.flashMessage.show(res['status'] + " : Welcome ^_^ ", { cssClass: "alert-success" });
                            _this.user.setLocalStorage('token', res['token']);
                            _this.user.setLocalStorage('userInfo', JSON.stringify(res['data']));
                            location.href = '/home';
                        }
                        else {
                            _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: "alert-danger" });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var SignupComponent = /** @class */ (function () {
                function SignupComponent(fb, user, router, flashMessage, route) {
                    this.fb = fb;
                    this.user = user;
                    this.router = router;
                    this.flashMessage = flashMessage;
                ...
                SignupComponent.prototype.getUserData = function () {
                    ...
                    this.user.getUserData().subscribe(function (res) {
                        if (res['status'] === "done") {
                            var data = res['data'];
                            _this.user.setLocalStorage('userInfo', JSON.stringify({ email: data['email'], fullName: data['firstname'] + " " + data['lastname'], profile: data['profile'] }));
                            _this.signupForm.patchValue({ email: data['email'], firstname: data['firstname'], lastname: data['lastname'] });
                        }
                        else {
                            _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: "alert-danger" });
                        }
                ...
                SignupComponent.prototype.getFormError = function () {
                    var _this = this;
                    Object.keys(this.signupForm.controls).forEach(function (controll) {
                        _this.signupFormErrors[controll] = '';
                        if (_this.signupForm.get(controll).invalid) {
                            Object.keys(_this.signupForm.get(controll).errors).forEach(function (error) {
                                _this.signupFormErrors[controll] += _my_validation__WEBPACK_IMPORTED_MODULE_5__["MyValidation"].errorMessage(error, controll);
                            });
                        }
                    });
                };
                SignupComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.user.loginOrSignupOrupdate(this.signupForm.value, this.pageCase).subscribe(function (res) {
                        if (res['status'] === "done") {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var RedirectComponent = /** @class */ (function () {
                function RedirectComponent(rout, url) {
                    var _this = this;
                    this.rout = rout;
                    this.url = url;
                    this.rout.paramMap.subscribe(function (params) {
                        var parser = params.get('parser');
                        if (parser) {
                            _this.url.getUrlParser(parser).subscribe(function (res) {
                                if (res['status'] === "done" && res['data']['status']) {
                                    var data = res['data'];
                                    _this.NotFound = "Welecome";
                                    location.href = data['link'];
                                }
                                else {
                                    _this.NotFound = "404 Not found";
                                }
                            }, function (err) {
                                _this.NotFound = "404 Not found";
                            });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UrlService = /** @class */ (function () {
                ...
                UrlService.prototype.allUrls = function () {
                ...
                UrlService.prototype.urlData = function (_id) {
                    var token = localStorage.getItem('token');
                ...
                UrlService.prototype.getUrlParser = function (parser) {
                    var token = localStorage.getItem('token');
                ...
                UrlService.prototype.deleteUrl = function (_id) {
                    var token = localStorage.getItem('token');
                ...
                UrlService.prototype.newOrUpdateUrl = function (data, path) {
                    var token = localStorage.getItem('token');
                ...
                UrlService.prototype.requsetError = function (error) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UrlComponent = /** @class */ (function () {
                function UrlComponent(url, fb, route, flashMessage) {
                    this.url = url;
                    this.fb = fb;
                    this.route = route;
                    this.flashMessage = flashMessage;
                ...
                UrlComponent.prototype.ngOnInit = function () {
                    ...
                    this.urlForm.valueChanges.subscribe(function (_) {
                        _this.getFormError();
                    });
                    this.route.paramMap.subscribe(function (params) {
                        ...
                        if (id) {
                            _this.urlCase['id'] = id;
                            _this.url.urlData(id).subscribe(function (res) {
                                if (res['status'] === "done") {
                                    var data = res['data'];
                                    _this.urlForm.get('link').setValue(data['link']);
                                    _this.urlForm.get('status').setValue(data['status']);
                                }
                                else {
                                    _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: "alert-danger" });
                                }
                ...
                UrlComponent.prototype.getFormError = function () {
                    var _this = this;
                    Object.keys(this.urlForm.controls).forEach(function (controll) {
                        _this.urlFormErrors[controll] = '';
                        if (_this.urlForm.get(controll).invalid) {
                            Object.keys(_this.urlForm.get(controll).errors).forEach(function (error) {
                                _this.urlFormErrors[controll] += _my_validation__WEBPACK_IMPORTED_MODULE_3__["MyValidation"].errorMessage(error, controll);
                            });
                        }
                    });
                };
                UrlComponent.prototype.hasError = function (field) {
                    return (this.urlForm.get(field).invalid && (this.urlForm.get(field).touched || this.urlForm.get(field).dirty));
                };
                UrlComponent.prototype.onSubmit = function () {
                    var _this = this;
                    var data = this.urlForm.value;
                    if (this.urlCase['id']) {
                        data['_id'] = this.urlCase['id'];
                    }
                    this.url.newOrUpdateUrl(data, this.urlCase['case']).subscribe(function (res) {
                        if (res['status'] === "done") {
                            _this.flashMessage.show(res['status'] + " : SuccessFull Task ", { cssClass: "alert-success" });
                        }
                        else {
                            _this.flashMessage.show(res['status'] + " : " + res['error'], { cssClass: "alert-danger" });
                        }
            ...
            UrlComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserInfoComponent = /** @class */ (function () {
                function UserInfoComponent(user, flashMessage) {
                    this.user = user;
                    this.flashMessage = flashMessage;
                    this.file = null;
                }
                ...
                UserInfoComponent.prototype.toggleUpload = function (stat) {
                    this.upladState = stat;
                };
                UserInfoComponent.prototype.loadFile = function (event) {
                ...
                UserInfoComponent.prototype.onSubmit = function () {
                    ...
                    if (this.file) {
                        ...
                        this.user.uploadProfile(formData).subscribe(function (res) {
                            if (res['body']) {
                                var body = res['body'];
                                if (body['status'] === 'done') {
                                    _this.flashMessage.show(body['status'] + " : uploading done ", { cssClass: "alert-success" });
                                    _this.userInfo['profile'] = body['profile'];
                                    _this.user.setLocalStorage('userInfo', JSON.stringify(_this.userInfo));
                                    _this.file = null;
                                }
                                else {
                                    _this.flashMessage.show(body['status'] + " : " + body['error'], { cssClass: "alert-danger" });
                                }
                            }
                        }, function (err) {
                            _this.flashMessage.show(err.message, { cssClass: "alert-danger" });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var UserService = /** @class */ (function () {
                function UserService(http) {
                    ...
                    }).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.requsetError)).subscribe(function (res) {
                        if (res['status'] === 'done')
                            _this.loginStatus = true;
                        else
                            _this.loginStatus = false;
                    }, function (err) { return _this.loginStatus = false; });
                }
                UserService.prototype.loginOrSignupOrupdate = function (data, path) {
                    var token = localStorage.getItem('token');
                ...
                UserService.prototype.uploadProfile = function (data) {
                    var token = localStorage.getItem('token');
                ...
                UserService.prototype.requsetError = function (error) {
                    if (error instanceof ErrorEvent) {
                        // A client-side or network error occurred. Handle it accordingly.
                        console.error('An error occurred:', error.error.message);
                    }
                ...
                UserService.prototype.setLocalStorage = function (key, value) {
